package hermes.client.view.change;
 ...
 * @author iuryk
 */
public class ChangeProduto extends HMPanel {

    public ChangeProduto() {
        initComponents();
        initFields();
    }
    ...
    /*public void buildProduto() {
     tf_codigo.setText(this.produto.getCodigo());
     tf_nome.setText(this.produto.getNome());
     tf_localizacao.setText(this.produto.getLocalizacao());
     cb_tipo.setSelectedItem(this.produto.getIdTipoProduto().getNome());
     tf_med_externa.setValue(this.produto.getMedidaExterna());
     tf_med_interna.setValue(this.produto.getMedidaInterna());
     cb_unidade.setSelectedItem(this.produto.getIdUnidade().getAbreviacao());
     tf_custo.setValue(this.estoque.getCusto());
     tf_valor.setValue(this.estoque.getValorVenda());
     spn_qtdade.setValue(this.estoque.getQuantidade());
     try {
     File f = FileUtils.getFile(this.produto.getFoto());
     this.foto = f;
     ImageIcon i = new ImageIcon(f.getAbsolutePath());
     System.out.println("File " + f.getAbsolutePath());
     i.setImage(i.getImage().getScaledInstance(182, 157, 100));
     lb_foto.setIcon(i);
     }
     catch (Exception e) {

     }
     for (Descricao d : new ProdutoController().getDescricoesByProduto(produto)) {
     tbl_desc.addObject(d);
     }
     for (Aplicacao a : new ProdutoController().getAplicacoesByProduto(produto)) {
     tbl_aplic.addObject(a);
     }
     tf_codigo.setValid(true);
     tf_nome.setValid(true);
     tf_localizacao.setValid(true);
     }*/
    ...
    private void initComponents() {
        ...
        btn_add_desc.setText("Adicionar");
        ...
        pn_descricaoLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pn_descricaoLayout.createSequentialGroup()
                ...
                .addComponent(btn_add_desc)
                .addGap(18, 18, 18)
                .addComponent(btn_rem_desc)
                .addGap(72, 72, 72))
        ...
        btn_add_aplic.setText("Adicionar");
        ...
        pn_aplicacoesLayout.setHorizontalGroup(
            ...
            .addGroup(pn_aplicacoesLayout.createSequentialGroup()
                .addGap(59, 59, 59)
                .addComponent(btn_add_aplic)
                .addGap(18, 18, 18)
                .addComponent(btn_rem_aplic)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        pn_aplicacoesLayout.setVerticalGroup(
            pn_aplicacoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pn_aplicacoesLayout.createSequentialGroup()
                .addGroup(pn_aplicacoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_add_aplic)
                    .addComponent(btn_rem_aplic))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pn_cadastro_produto, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
        );
